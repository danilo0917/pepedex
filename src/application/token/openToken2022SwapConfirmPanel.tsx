...
function FeeInfoRow({
  ...
  return (
    <Col className={twMerge('table text-sm mx-auto py-4 gap-1 items-center text-color')}>
...
function InfoItemHeader({ coin }: { coin?: SplToken }) {
  return (
    <Row className="gap-2 p-4 bg-field rounded-xl justify-center">
      <Row className="gap-2 justify-center items-center text-color">
