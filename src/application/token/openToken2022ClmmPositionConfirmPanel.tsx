...
function FeeInfoRow({
  ...
  return (
    <Grid className={twMerge('grid-cols-2 mobile:grid-cols-1 gap-4 items-center text-color', className)}>
      <Col className="gap-3">
...
function PositionHeader({
  ...
  return (
    <Row className="gap-4 p-4 bg-field rounded-xl justify-between">
      <AutoBox is={isMobile ? 'Col' : 'Row'} className="clickable flex-wrap items-center mobile:items-start">
        ...
        <Row className="mobile:text-xs font-medium mobile:mt-px items-center flex-wrap gap-2">
          <Col>
            <Row className="items-center text-color">
