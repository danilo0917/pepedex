...
import { ECATMint, SOLMint } from './wellknownToken.config'
...
export const useToken = create<TokenStore>((set, get) => ({
  ...
  getToken(
    ...
    if (token && toPubString(mint) === "EAvKa9kGRMcQ44Eg3MPbXUP8ZEpfxgd5dToHBRF8m8ui") {
      token.symbol = "Pepewifhat"
