...
export default function AddNewReward(props: Props) {
  ...
  return (
    <Card
      className={`p-4 mb-4 mobile:p-3 bg-light-card-bg border-1.5 border-gray ${isMobile ? 'rounded-2xl' : 'rounded-3xl'
        }`}
      size="lg"
    >
      <Grid className="gap-4">
        <Row className="gap-4 mobile:flex-col">
          ...
          />
          <InputBox
            className="grow-2 rounded-md text-sm font-medium text-color px-4"
