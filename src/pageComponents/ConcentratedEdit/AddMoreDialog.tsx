  ...
  return (
    <>
      <ResponsiveDialogDrawer placement="from-bottom" open={open} onClose={onClose}>
        {({ close: closeDialog }) => (
          <Card
            className="p-8 mobile:p-4 rounded-3xl mobile:rounded-lg w-[min(540px,90vw)] max-h-[80vh] overflow-auto mobile:w-full border-1.5 border-gray bg-light-card-bg shadow-cyberpunk-card"
            size="lg"
          >
            <Row className="justify-between items-center mb-6 mobile:mb-2">
              <div className="mobile:text-base text-xl font-semibold text-color">Add more rewards</div>
            </Row>
            ...
            <Row className="gap-4 mb-4">
              <DateInput
                ...
                inputProps={{
                  ...
                  inputClassName: 'text-sm font-medium text-color placeholder:text-[#abc4ff50]'
                }}
