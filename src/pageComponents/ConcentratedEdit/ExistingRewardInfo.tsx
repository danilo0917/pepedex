      ...
      <ListTable
        ...
        renderRowItem={({ item: reward, label, index }) => {
          ...
          const getRewardBadge = () => {
            ...
            if (isRewarding)
              return (
                <Badge className="w-fit" cssColor="#D0D0D8">
                  Ongoing
                </Badge>
              )
            return null
          ...
          if (label === 'Amount') {
            ...
            return (
              <Grid className="gap-4 h-full">
                ...
                {updateReward && (
                  <Col className="grow justify-center text-color">
                ...
                {updateReward && (
                  <Col className="grow justify-center text-color">
                    <Row className="break-all items-center gap-1">
                      ...
                      <Badge cssColor="#D0D0D8">{showUpdateOnly ? 'Updated' : 'New'}</Badge>
                    </Row>
                  </Col>
                )}
              </Grid>
        ...
        renderControlButtons={({ itemData: reward }) => {
          ...
          return updateData.get(reward.rewardToken!.mint.toBase58()) ? (
            <Badge
              ...
              cssColor={previewMode ? '#D0D0D8' : '#abc4ff'}
