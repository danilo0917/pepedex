  ...
  if (walletConnected && owner && isMintEqual(currentAmmPool?.creator, owner)) {
    return (
      <div className="max-w-[720px]">
        ...
        <div className="text-color text-sm mb-4">
        ...
        {canAddRewardToken && (
          <>
            ...
            >
              <Icon className="text-color" heroIconName="plus-circle" size="sm" />
              <div className="ml-1.5 text-color font-base mobile:text-sm">Add reward token</div>
        ...
        {txSuccess ? (
          <div className="mb-4 text-color text-center text-sm">Farming rewards successfully updated</div>
        ) : null}
        ...
        {!showPreview && (
          <div className="flex mt-12">
            <Icon className="text-color mr-[15px]" heroIconName="exclamation-circle" size="md" />
            <div className="p-6 bg-[#1B1659] rounded-[20px] border-1.5 border-gray text-left text-sm text-[rgb(255,255,255)]">
              <div className="text-color font-medium font-base mobile:text-sm">How to adjust existing rewards?</div>
