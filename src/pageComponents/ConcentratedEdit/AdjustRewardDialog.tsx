  ...
  return (
    <>
      <ResponsiveDialogDrawer placement="from-bottom" open={!!reward} onClose={onClose}>
        {({ close: closeDialog }) => (
          <Card
            className="p-8 mobile:p-4 rounded-3xl mobile:rounded-lg w-[min(698px,90vw)] max-h-[80vh] mobile:w-full border-1.5 border-gray bg-light-card-bg shadow-cyberpunk-card"
            size="lg"
          >
            <Row className="justify-between items-center mb-6 mobile:mb-2">
              <div className="mobile:text-base text-xl font-semibold text-color">Adjust rewards</div>
                      ...
                      <Grid className="gap-4 h-full">
                        {perSecond ? (
                          <Col className="grow gap-2 break-all justify-center text-xs">
                            <div className="text-color text-base">
                      ...
                      <Grid className="h-full">
                        {endTime ? (
                          <Col className="justify-center gap-2 text-xs">
                            <span className="text-color text-base">{toUTC(endTime)}</span>
                      ...
                      <Grid className="gap-4 h-full">
                        <Col className="grow justify-center text-xs gap-2">
                          <div className=" text-base">
                            <span className="text-color">{formatNumber(rewardPerWeek!)}&nbsp;</span>
                            {rewardToken?.symbol}
                            /week
                          </div>
                          {apr} APR
                      ...
                      if (label === 'Rate') {
                        return (
                          <Grid className="gap-4 h-full">
                            <Col className="grow justify-center text-xs gap-2">
                              <div className=" text-base">
                                <span className="text-color">{formatNumber(newPerWeek)}&nbsp;</span>
                                {rewardToken?.symbol}
                                /week
                              </div>
                              {newApr} APR
            ...
            <Row className="justify-between items-center mt-10 mobile:mb-2">
              ...
              <Button
                type="text"
                className="text-sm text-color frosted-glass-skygray min-w-[120px]"
                onClick={closeDialog}
              >
                Cancel
              </Button>
