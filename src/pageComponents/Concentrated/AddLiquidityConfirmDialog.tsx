  ...
  return (
    <Dialog open={open} onClose={close}>
      {({ close }) => (
        <Card
          className={twMerge(
            `p-6 mobile:py-4 mobile:px-2 rounded-3xl w-[min(480px,95vw)] mx-8 border-1.5 border-gray  bg-light-card-bg shadow-cyberpunk-card`
          )}
          size="lg"
        >
          {nftHasLoaded ? (
            <>
              <Row className="justify-between items-center mb-6 mobile:mb-3">
                <div className="text-xl font-semibold text-color mobile:text-base">Deposit Confirmed</div>
              ...
              <div className="my-4 mx-4 space-y-4">
                ...
                <Col className="gap-2 items-center">
                  ...
                  <Row className="text-sm text-color font-medium gap-2">
                    <div>NFT Mint:</div>
            ...
            <>
              <Row className="justify-between items-center mb-6 mobile:mb-3">
                <div className="text-xl font-semibold text-color mobile:text-base">
              ...
              <div className="mt-4 border-1.5 border-[#abc4ff40] rounded-xl p-3 mobile:p-2 mobile:mt-3">
                ...
                <div className="text-sm flex leading-[18px] flex-col pt-2.5">
                    ...
                    <Col className="items-end">
                      ...
                      {isMeaningfulNumber(coin1AmountFee) && (
                        <Row className="text-xs text-[#abc4ff80] gap-0.5 items-center">
                          ...
                          <Row className="text-[#7e7a2f] font-medium gap-0.5 items-center">
                            <span>Fee</span>
                            <Tooltip>
                  ...
                  <div className="flex justify-between mt-2 pl-1">
                    <span className="flex items-center text-sm text-color">Fee tier</span>
