...
export default forwardRef(function Chart(props: Props, ref) {
  ...
  return (
    <>
          ...
          <div className="flex gap-2 select-none">
            ...
            <div style={chartControlStyle}>
              <Icon
                size="sm"
                onClick={zoomOut}
                className="text-color saturate-50 brightness-125 cursor-pointer"
      ...
      <div>
        <div className="flex items-center text-xs text-color">
          <span className="inline-block w-[8px] h-[2px] bg-field mr-2" />
        ...
        <div className="flex items-center text-xs text-color">
          <span className="inline-block w-[8px] h-[2px] bg-[#D0D0D8] mr-2" />
      ...
      <div className="w-full select-none" style={{ height: `${height || 140}px` }}>
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            {priceMin && (
              <ReferenceLine isFront={true} x={priceMin} stroke="#D0D0D8" strokeDasharray="4" strokeWidth={2} />
            )}
            {priceMax && (
              <ReferenceLine isFront={true} x={priceMax} stroke="#D0D0D8" strokeDasharray="4" strokeWidth={2} />
            )}
      ...
      {showCurrentPriceOnly ? null : (
        <div className="flex justify-between flex-wrap gap-2">
          {enableRates.map((r) => (
            <div
              key={r}
              className={`whitespace-nowrap mb-3 text-xs text-center border flex-1 ${r === rate ? 'border-[#ABC4FF] bg-field' : 'border-[#36427D] opacity-50'
