  ...
  return (
    ...
    >
      <Row className="justify-between items-center p-8">
        <div className="text-xl font-semibold text-color">Recent transactions</div>
      ...
      >
        {/* table head column: Transaction type */}
        <div className="font-medium text-gray-300 text-xs">Transaction type</div>
        {/* table head column: Details */}
        <div className="font-medium text-gray-300 text-xs">Details</div>
        {/* table head column: Date and time */}
        <div className="font-medium text-gray-300 text-xs">Date and time</div>
      </Row>
      ...
      <Row className="border-t-1.5 border-gray">
        <LinkExplorer
          className="py-4 rounded-none flex-grow font-medium text-color text-xs flex justify-center gap-1 items-center"
