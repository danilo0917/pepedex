      ...
      <Fieldset
        ...
        renderFormItem={
          <Input
            ...
            className={`p-3 ${newCreatedMarketId ? 'opacity-50 pointer-events-none' : ''} rounded-lg bg-[#0f1823]`}
...
function SelectTokenInputBox({
  ...
  return (
    <>
      <Grid
        className="grid items-center bg-[#0f1823] rounded-xl py-2 mobile:py-1.5 cursor-pointer px-3 mobile:px-2"
