      ...
      <Popover.Panel>
        {({ locationInfo }) => (
          <div className="relative">
            <div
              className={twMerge(
                'w-2 h-2 absolute bg-tooltip rotate-45 -translate-x-1 -translate-y-1',
            ...
            />
            <Card
              className={twMerge('TooltipPanel p-4 bg-tooltip rounded-lg text-md text-tooltip drop-shadow', panelClassName)}
              style={{
