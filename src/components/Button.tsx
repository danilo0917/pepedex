...
function solidButtonTailwind({
  ...
  return `${size === 'lg'
    ...
    } whitespace-nowrap appearance-none ${disable
      ? `bg-formkit-thumb-disable text-formkit-thumb-text-disabled opacity-40 ${haveFallbackClick ? '' : 'cursor-not-allowed'
      }`
...
function outlineButtonTailwind({
  ...
  return `${size === 'lg'
    ...
    } whitespace-nowrap appearance-none ring-1.5 ring-inset ring-current ${disable ? `opacity-40 ${haveFallbackClick ? '' : 'cursor-not-allowed'}` : 'clickable clickable-filter-effect'
    }`
}
  ...
  return `${size === 'lg'
    ...
    : size === 'sm'
      ...
      : size === 'xs'
        ? 'px-4 py-2 text-xs rounded-xl'
        : 'px-4 py-2.5  rounded-xl mobile:rounded-lg'
    } whitespace-nowrap appearance-none font-medium text-color ${disable ? `opacity-40 ${haveFallbackClick ? '' : 'cursor-not-allowed'}` : 'clickable'
    }`
}
